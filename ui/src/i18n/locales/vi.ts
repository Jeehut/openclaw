...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Bản nháp",
    draftDescription: "Giữ luồng này ở chế độ riêng tư cho đến khi bạn xuất bản nó",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming là một cài đặt toàn cục; nó không giới hạn cho agent này.",
      enableTitle: "Bật Dreaming cho Tất cả Agent",
      enableDetail:
        "Đợt quét dreaming hàng đêm sẽ chạy trên mọi không gian làm việc agent đã cấu hình, chuyển các recall ngắn hạn thành bộ nhớ dài hạn. Điều này áp dụng ngay lập tức.",
      enableConfirm: "Bật Dreaming",
      disableTitle: "Tắt Dreaming cho Tất cả Agent",
      disableDetail:
        "Đợt quét dreaming hàng đêm sẽ dừng cho mọi agent đã cấu hình, không chỉ agent này. Các bộ nhớ đã ghi vẫn được giữ; không có gì mới được chuyển lên. Điều này áp dụng ngay lập tức.",
  ...
  chat: {
    ...
    sidebarColumns: {
      ...
      close: "Đóng {panel}",
      drag: "Kéo {panel}",
      dropOnEmptyLeft: "Chuyển {panel} sang thanh bên trái trống",
      dropOnEmptyRight: "Chuyển {panel} sang thanh bên phải trống",
