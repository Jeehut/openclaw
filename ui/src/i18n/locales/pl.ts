...
export const pl: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Nocne przemiatanie śnienia obejmie każdy skonfigurowany obszar roboczy agenta, przenosząc krótkotrwałe wspomnienia do pamięci długotrwałej. Obowiązuje natychmiast.",
      enableConfirm: "Włącz śnienie",
      disableTitle: "Wyłącz śnienie dla wszystkich agentów",
      disableDetail:
        "Nocne przemiatanie śnienia zatrzyma się dla każdego skonfigurowanego agenta, nie tylko tego. Już zapisane wspomnienia pozostają; nic nowego nie zostanie przeniesione. Obowiązuje natychmiast.",
