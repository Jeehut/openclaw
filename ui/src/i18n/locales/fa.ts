...
export const fa: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "روبش رؤیاپردازی شبانه در سراسر هر فضای کاری عامل پیکربندی‌شده اجرا می‌شود و یادآوری‌های کوتاه‌مدت را به حافظه بلندمدت ارتقا می‌دهد. این تغییر بلافاصله اعمال می‌شود.",
      enableConfirm: "روشن کردن رؤیاپردازی",
      disableTitle: "خاموش کردن رؤیاپردازی برای همه عامل‌ها",
      disableDetail:
        "روبش رؤیاپردازی شبانه برای هر عامل پیکربندی‌شده متوقف می‌شود، نه فقط این یکی. خاطراتی که قبلاً نوشته شده‌اند باقی می‌مانند؛ چیز جدیدی ارتقا نمی‌یابد. این تغییر بلافاصله اعمال می‌شود.",
