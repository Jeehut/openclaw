...
export const fr: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Le balayage nocturne de rêve s'exécutera sur chaque espace de travail d'agent configuré, transférant les souvenirs à court terme vers la mémoire à long terme. Ceci s'applique immédiatement.",
      enableConfirm: "Activer le rêve",
      disableTitle: "Désactiver le rêve pour tous les agents",
      disableDetail:
        "Le balayage nocturne de rêve s'arrêtera pour chaque agent configuré, et pas seulement celui-ci. Les souvenirs déjà écrits sont conservés ; rien de nouveau n'est transféré. Ceci s'applique immédiatement.",
