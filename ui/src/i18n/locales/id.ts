...
export const id: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Draf",
    draftDescription: "Simpan thread ini untuk diri Anda sendiri hingga Anda memublikasikannya",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Sapuan dreaming malam hari akan berjalan di setiap workspace agen yang dikonfigurasi, mempromosikan recall jangka pendek menjadi memori jangka panjang. Ini berlaku segera.",
