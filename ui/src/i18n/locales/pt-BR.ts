...
export const pt_BR: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "A varredura noturna de dreaming será executada em todos os espaços de trabalho de agentes configurados, promovendo memórias de curto prazo para a memória de longo prazo. Isso é aplicado imediatamente.",
      enableConfirm: "Ativar Dreaming",
      disableTitle: "Desativar Dreaming para Todos os Agentes",
      disableDetail:
        "A varredura noturna de dreaming será interrompida para todos os agentes configurados, não apenas este. As memórias já gravadas permanecem; nada novo é promovido. Isso é aplicado imediatamente.",
