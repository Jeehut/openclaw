...
export const uk: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Нічне сканування dreaming виконуватиметься в кожному налаштованому робочому просторі агента, переносячи короткострокові спогади в довгострокову пам’ять. Застосовується негайно.",
      enableConfirm: "Увімкнути Dreaming",
      disableTitle: "Вимкнути Dreaming для всіх агентів",
      disableDetail:
        "Нічне сканування dreaming зупиниться для кожного налаштованого агента, а не лише для цього. Уже записані спогади залишаться; нічого нового не переноситься. Застосовується негайно.",
