...
export const de: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Der nächtliche Dreaming-Durchlauf wird über jeden konfigurierten Agenten-Workspace ausgeführt und überführt kurzfristige Erinnerungen in das Langzeitgedächtnis. Dies gilt sofort.",
  ...
  chat: {
    ...
    sidebarColumns: {
      ...
      resize: "{panel} in der Größe ändern",
    },
    thread: {
