...
export const ja_JP: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "夜間の Dreaming スイープが設定済みのすべてのエージェントワークスペースで実行され、短期のリコールを長期記憶へと昇格させます。これはすぐに適用されます。",
      enableConfirm: "Dreaming を有効にする",
      disableTitle: "すべてのエージェントで Dreaming を無効にする",
      disableDetail:
        "夜間の Dreaming スイープは、このエージェントだけでなく設定済みのすべてのエージェントで停止します。すでに書き込まれた記憶は残りますが、新たに昇格されるものはありません。これはすぐに適用されます。",
