...
export const ko: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "야간 dreaming 스윕이 구성된 모든 에이전트 작업 공간에서 실행되어 단기 기억을 장기 기억으로 승격합니다. 이 설정은 즉시 적용됩니다.",
      enableConfirm: "Dreaming 켜기",
      disableTitle: "모든 에이전트에 대해 Dreaming 끄기",
      disableDetail:
        "야간 dreaming 스윕이 이 에이전트뿐 아니라 구성된 모든 에이전트에서 중지됩니다. 이미 기록된 기억은 유지되며, 새로 승격되는 항목은 없습니다. 이 설정은 즉시 적용됩니다.",
