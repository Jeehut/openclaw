...
export const nl: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming is een globale instelling; het geldt niet alleen voor deze agent.",
      enableTitle: "Dreaming inschakelen voor alle agents",
      enableDetail:
        "De nachtelijke dreaming-sweep draait over elke geconfigureerde agent-workspace en promoveert kortetermijnherinneringen naar langetermijngeheugen. Dit geldt meteen.",
      enableConfirm: "Dreaming inschakelen",
      disableTitle: "Dreaming uitschakelen voor alle agents",
      disableDetail:
        "De nachtelijke dreaming-sweep stopt voor elke geconfigureerde agent, niet alleen deze. Reeds geschreven herinneringen blijven; er wordt niets nieuws gepromoveerd. Dit geldt meteen.",
  ...
  chat: {
    ...
    sidebarColumns: {
      ...
      resize: "Formaat wijzigen van {panel}",
    },
    thread: {
