...
export const tr: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Taslak",
    draftDescription: "Bu konuşmayı yayımlayana kadar kendinize saklayın",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Gece rüya görme taraması, yapılandırılmış her aracı çalışma alanında çalışarak kısa süreli hatırlamaları uzun süreli belleğe aktaracaktır. Bu hemen uygulanır.",
      enableConfirm: "Rüya Görmeyi Aç",
      disableTitle: "Tüm Aracılar İçin Rüya Görmeyi Kapat",
      disableDetail:
        "Gece rüya görme taraması yalnızca bu aracı için değil, yapılandırılmış her aracı için duracaktır. Zaten yazılmış anılar kalır; yeni hiçbir şey aktarılmaz. Bu hemen uygulanır.",
